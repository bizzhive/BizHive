      ...
      <div className="container mx-auto px-4">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              <Tabs defaultValue="signin" className="w-full max-w-md mx-auto" onValueChange={(val) => setIsSignUp(val === "signup")}>
                ...
                <Card>
                  ...
                  <CardContent>
                    ...
                    <Button type="button" className="w-full border border-input bg-background text-foreground hover:bg-accent hover:text-accent-foreground" onClick={handleGoogleLogin} disabled={isLoading}>
