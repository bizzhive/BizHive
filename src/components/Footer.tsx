...
import { LockKeyhole, Mail, ShieldCheck, Star, Sparkles } from "lucide-react";
  ...
  return (
    <footer className="border-t border-border/60 py-10 sm:py-12">
      <SiteContainer className="space-y-6">
        <Surface className="grid gap-6 xl:grid-cols-[0.92fr_1.08fr]">
          ...
          <div className="grid gap-4 md:grid-cols-[1fr_auto]">
            <div className="panel-muted space-y-4 p-5">
              <div className="space-y-2">
                ...
                <p className="text-sm leading-7 text-muted-foreground">{t("feedback.description")}</p>
              </div>
            ...
            <div className="flex flex-col gap-3">
              <PremiumModal
                trigger={
                  <Button variant="ghost" className="glass-button h-12 justify-between">
                    <span className="flex items-center gap-2">
                      <Sparkles className="h-4 w-4 text-primary" />
                      {t("premium.cta")}
                    </span>
                    <span>{t("premium.previewAction")}</span>
                  </Button>
                }
              />
              ...
              <AdminAccessDialog
                ...
                trigger={
                  <Button variant="ghost" className="glass-button h-12 justify-between">
                    ...
                    <span>{t("footer.adminAction")}</span>
                  </Button>
                }
              />

              <div className="panel-muted flex min-h-[136px] flex-col justify-between p-4">
                <div className="flex items-center gap-2 text-sm font-semibold text-foreground">
                  <LockKeyhole className="h-4 w-4 text-primary" />
                  {t("footer.foundationTitle")}
                </div>
                <p className="text-sm leading-7 text-muted-foreground">{t("footer.foundationBody")}</p>
              </div>
            </div>
          </div>
        </Surface>
